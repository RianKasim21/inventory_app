                    ...
                    <form method="POST" action="{{ route('barang.update', $barang) }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="kategori" id="kategori"
                                ...
                                placeholder="Masukkan atau pilih kategori" required>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            ...
                            <div>
                                ...
                                <input type="number" name="harga_satuan" id="harga_satuan"
                                    value="{{ old('jumlah', $barang->harga_satuan) }}" min="0"
                        ...
                        <div class="mb-6 p-4 bg-blue-50 border-l-4 border-blue-400 text-blue-700">
                            <p class="text-sm">
                                <strong>Terakhir diperbarui:</strong> {{ $barang->updated_at->format('d M Y, H:i') }}
                            </p>
                        </div>
